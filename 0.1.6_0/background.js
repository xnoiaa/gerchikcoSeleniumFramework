...
cors.onHeadersReceived = d => {
  ...
  if (prefs['allow-headers'] === true) {
    ...
    if (o) {
      o.value = origin || prefs['allow-headers-value'];
    }
    else {
      responseHeaders.push({
        'name': 'Access-Control-Allow-Headers',
        'value': origin || prefs['allow-headers-value']
      });
    }
  }
  if (prefs['allow-headers'] === true) {
    ...
    if (o) {
      o.value = origin || prefs['expose-headers-value'];
    }
    else {
      responseHeaders.push({
        'name': 'Access-Control-Expose-Headers',
        'value': origin || prefs['expose-headers-value']
      });
    }
  }
